...
public class Xlsx_ReaderTest {
	...
	public void setUp()
	{
		datatable = new XlsxReader("C:\\Lavanya\\Project\\eTouch\\eTap_framework\\staff.xlsx");
	}
	...
	public void isDataSet()
	{
		   ...
		   Assert.assertTrue(datatable.setCellData("E1", "Age", 3, "30", "C:/Lavanya/Project/eTouch/eTap_framework/emp1.xls"));
	}
